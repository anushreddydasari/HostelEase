                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <textarea name="feedSuggestion" class="form-control form-control-alternative"
                          id="input-suggestions" rows="3" placeholder="We'd love to here some suggestions.."></textarea>
                      </div>
                    </div>
                    <!-- <div class="col-lg-6">
                        <div class="form-group">
